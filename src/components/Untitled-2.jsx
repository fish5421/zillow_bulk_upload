...
const App = () => {
  ...
  const handleS3Upload = async () => {
    ...
    if (file) {
      const result = await uploadToS3(file, userInfo);
  ...
  return (
    <div className="relative">
      ...
      <div className="relative flex flex-col items-center justify-center h- z-10">
            ...
            <table className="w-full text-base text-left text-gray-500 dark:text-gray-400 ">
              ...
              <tbody>
                <tr className="bg-white dark:bg-gray-800">
                  ...
                  <td className="px-6 py-4">{pricingResult}</td>
                </tr>
              </tbody>
            </table>
          </div>
